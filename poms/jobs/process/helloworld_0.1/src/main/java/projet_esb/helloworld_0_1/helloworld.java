...
package projet_esb.helloworld_0_1;
...
public class helloworld implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(helloworld.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final helloworld job;

		public RestServiceProviderImpl4TalendJob(helloworld job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, helloworld job) {
		...
		public javax.ws.rs.core.Response out1(
			...
			request_tRESTRequest_1.put("OPERATION", "out1");
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(helloworld job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = helloworld.class.getClassLoader()
					.getResourceAsStream("projet_esb/helloworld_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = helloworld.class.getClassLoader()
	...
	public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		final static byte[] commonByteArrayLock_PROJET_ESB_helloworld = new byte[0];
		static byte[] commonByteArray_PROJET_ESB_helloworld = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_ESB_helloworld) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 0, 0, "out1", "out2");
				}
...
//    	this.treeNodeAPI = treeNodeAPI;
						...
						// input table.
						void generateElements(boolean isInnerJoin, out1Struct out1, Var__tXMLMap_1__Struct Var) {
...
// build root xml tree 
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						java.util.Map<String, Object> params_tRESTRequest_1 = (java.util.Map<String, Object>) requestMessage_tRESTRequest_1
								.get("PARAMS");
						if (matchedFlow_tRESTRequest_1.equals("out1")) {
							out1 = new out1Struct();
...
// # Output table : 'out2'
							...
							gen_Doc_out2_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1, out1, Var);
...
// Start of branch "out2"
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 2, 0, "out1", "out2");
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = helloworld.class.getClassLoader()
					.getResourceAsStream("projet_esb/helloworld_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = helloworld.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : helloworld");
		}
...
/************************************************************************************************
 * 75160 characters generated by Talend Open Studio for ESB on the 6 mars 2024 à
 * 22:37:43 CET
 ************************************************************************************************/